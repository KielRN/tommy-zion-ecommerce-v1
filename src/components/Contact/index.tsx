              ...
              <form>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full p-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-tommyzion-red/20"
                  ></textarea>
                </div>
