              ...
              <form>
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-3 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-tommyzion-red/20"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-tommyzion-black py-3 px-6 rounded-lg ease-out duration-200 hover:bg-tommyzion-black/90 mt-7.5"
                >
                  Sign in to account
                </button>
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="text-dark ease-out duration-200 hover:text-tommyzion-red pl-2"
                  >
                    Sign Up Now!
                  </Link>
                </p>
