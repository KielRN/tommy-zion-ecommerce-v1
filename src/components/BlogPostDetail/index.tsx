...
const BlogPostDetail = ({ post, htmlContent, relatedPosts }: BlogPostDetailProps) => {
  return (
          ...
          <div className="lg:max-w-[750px] w-full">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h4 className="text-dark text-custom-sm font-medium">{post.author.name}</h4>
                  {post.author.bio && (
                    <p className="text-custom-xs text-gray-6">{post.author.bio}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-10 mt-10 pt-10 border-t border-gray-3">
              ...
              <div className="flex items-center gap-3">
                <a
                  href={`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}&media=${encodeURIComponent(post.featuredImage)}&description=${encodeURIComponent(post.title)}`}
                  target="_blank"
            ...
            {relatedPosts.length > 0 && (
              <div className="mt-15 pt-10 border-t border-gray-3">
                <h3 className="text-xl font-medium text-dark mb-8">Related Posts</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {relatedPosts.map((relatedPost) => (
                    <div key={relatedPost.slug} className="bg-white rounded-lg p-4 shadow-1">
                      <Link href={`/blog/${relatedPost.slug}`}>
                        ...
                        />
                        <h4 className="font-medium text-dark hover:text-blue transition-colors">
                          {relatedPost.title}
                        </h4>
                        <p className="text-sm text-gray-6 mt-2 line-clamp-2">
                          {relatedPost.excerpt}
                        </p>
                      </Link>
                    </div>
