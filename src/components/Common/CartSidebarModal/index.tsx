          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full flex justify-center font-medium text-white bg-tommyzion-black py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-tommyzion-black-dark"
              >
                View Cart
              </Link>
