  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-tommyzion-black text-white hover:bg-tommyzion-black hover:text-white"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-tommyzion-black hover:text-white"
        >
          <div className="relative">
